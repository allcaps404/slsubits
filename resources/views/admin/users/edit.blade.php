            ...
            <div class="col-md-3 mb-3">
                <div class="form-group">
                    ...
                    <select class="form-control" name="year" id="year">
                        ...
                        <option value="1st" {{ old('year', $user->OtherDetail->year ?? '') == '1st' ? 'selected' : '' }}>1st Year</option>
                        <option value="2nd" {{ old('year', $user->OtherDetail->year ?? '') == '2nd' ? 'selected' : '' }}>2nd Year</option>
                        <option value="3rd" {{ old('year', $user->OtherDetail->year ?? '') == '3rd' ? 'selected' : '' }}>3rd Year</option>
                        <option value="4th" {{ old('year', $user->OtherDetail->year ?? '') == '4th' ? 'selected' : '' }}>4th Year</option>
                    </select>
                </div>
            </div>
            <div class="col-md-3 mb-3">
